...
enum AnnotationMode {
    ...
    Mode_Merge = (1 << 12) | Brush | ObjectSelection | ObjectMerge,
    Mode_MergeSimple = (1 << 13) | Brush | ObjectMerge,

    Mode_MergeTracing = (1 << 14) | NodeEditing | LinkedNodes | SkeletonCycles,

    Mode_Selection = (1 << 15) | NodeSelection | ObjectSelection,

    Mode_Brainmaps = (1 << 16) | Brush | ObjectSelection | NodeEditing,
};
